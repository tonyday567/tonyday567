...
|]
  where
    citext :: String
    citext = if ci == CI then [i|[![CI](https://github.com/#{user}/#{repo}/actions/workflows/haskell-ci.yaml/badge.svg?branch=main)](https://github.com/#{user}/#{repo}/actions)|] else mempty
